...
public class LoaderUtility {
     ...
     */
    public static OpenGLComponent.Vao createVao() {
        OpenGLComponent.Vao myVao = new OpenGLComponent.Vao(glGenVertexArrays());
     ...
     */
    public static OpenGLComponent.Vbo createVbo() {
        return new OpenGLComponent.Vbo(glGenBuffers());
    }
     ...
     */
    public static void insertPositionIntoVbo(OpenGLComponent.Vbo myVbo, float[] positions) {
     ...
     */
    public static void insertTextureIntoVbo(OpenGLComponent.Vbo myVbo, float[] textCoords) {
     ...
     */
    public static void insertIndicesIntoVbo(OpenGLComponent.Vbo myVbo, int[] indices) {
     ...
     */
    public static void insertNormalsIntoVbo(OpenGLComponent.Vbo myVbo, float[] normals) {
     ...
     */
    private static void insertIntoVbo(Buffer buffer, OpenGLComponent.Vbo myVbo, int size, int index) {
